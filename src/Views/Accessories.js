      ...
      <main>
        <article>
          ...
          <section>
            ...
            <h3 class="titleColor" id="controllerTitle">
              DualSense® wireless controller
            </h3>
            <p>
              Nibh metus ut,
              <u class="italic bold" id="eleShad">
            ...
            <h3 class="titleColor">DualSense Edge™ wireless controller</h3>
            <p>
          ...
          <section>
            ...
            <h3 class="titleColor">PULSE Elite™ wireless headset</h3>
            <p>
          ...
          <p>
            Chance to
            <span class="bold text-primary text-decoration-underline">
              WIN 25% OFF!!
            </span>
